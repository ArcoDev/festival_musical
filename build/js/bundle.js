...
function crearGaleria() {
    ...
    for (let t = 1; t <= 12; t++) {
        ...
        n.src = `build/img/thumb/${t}.webp`, n.dataset.imagenId = t, n.onclick = mostrarImagen;
...
function mostrarImagen(e) {
    ...
    o.appendChild(n), o.classList.add("overlay"), o.onclick = function () {
        o.remove(), c.classList.remove("fijar-body")
    };
    const a = document.createElement("P");
    a.textContent = "X", a.classList.add("btn-cerrar"), a.onclick = function () {
        o.remove(), c.classList.remove("fijar-body")
    }, o.appendChild(a);
    const c = document.querySelector("body");
    c.appendChild(o), c.classList.add("fijar-body")
}
